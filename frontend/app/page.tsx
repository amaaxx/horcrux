    ...
    <main className="relative w-full h-[100dvh] flex flex-col bg-background text-white font-sans selection:bg-accent selection:text-white overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col h-full max-w-6xl w-full mx-auto px-4 py-3 sm:px-6 sm:py-4 md:px-8 md:py-5 gap-3 md:gap-5">
        ...
        <motion.header
          ...
          className="flex-none"
        >
          {/* Mobile hero — single line, very compact */}
          <h1 className="text-[clamp(1.75rem,7vw,3.25rem)] font-bold tracking-tight leading-none mb-1 md:mb-2">
            Amaan.{" "}
        ...
        <motion.section
          ...
          className={[
            "flex-1 min-h-0",
            // Mobile: 2-col × 3-row compact grid
            "grid grid-cols-2 grid-rows-3 gap-2",
            // Desktop: 3-col with custom rows
            "md:grid-cols-3 md:gap-4 md:[grid-template-rows:2fr_2fr_1.6fr]",
          ].join(" ")}
        >

          {/* ── VESSEL 01: Ground Truth Engine ──────────────── */}
          {/* Mobile: spans 2 cols, 1 row | Desktop: 2 cols, 2 rows */}
          <Link
            href="/vessel/ground-truth-engine"
            className="col-span-2 md:col-span-2 md:row-span-2 block"
          >
            <motion.div
              variants={item}
              className="relative overflow-hidden bg-surface border border-border rounded-2xl md:rounded-3xl p-4 md:p-8 h-full flex flex-col justify-end transition-all duration-300 hover:border-neutral-600 active:scale-[0.98] active:border-neutral-500 group"
            >
              ...
              <div className="relative z-10 mt-auto pt-10 md:pt-24">
                ...
                <div className="flex flex-wrap gap-1.5 md:gap-2">
                  {["Python", "Vector DB", "FastAPI", "Next.js 15"].map((tech) => (
                    <span
                      key={tech}
                      className="px-2 py-0.5 md:px-3 md:py-1 text-[9px] md:text-[11px] font-mono text-neutral-300 bg-neutral-800/50 rounded-full border border-neutral-700/50"
                    >
                      {tech}
                    </span>
                  ))}
          ...
          <Link href="/vessel/strata" className="block h-full">
            <motion.div
              variants={item}
              className="relative overflow-hidden bg-surface border border-border rounded-2xl md:rounded-3xl p-3 md:p-6 h-full flex flex-col transition-all duration-300 hover:border-neutral-600 active:scale-[0.98] active:border-neutral-500 group"
            >
              ...
              <div className="relative z-20 flex-none shrink-0">
                <h2 className="text-sm md:text-xl font-bold mb-0.5 group-hover:text-accent transition-colors duration-300">
                  Strata
                </h2>
          ...
          <Link href="/vessel/core-stack" className="block h-full">
            <motion.div
              variants={item}
              className="relative overflow-hidden bg-surface border border-border rounded-2xl md:rounded-3xl px-3 py-3 md:px-6 md:pt-5 md:pb-5 h-full flex flex-col transition-all duration-300 hover:border-neutral-600 active:scale-[0.98] active:border-neutral-500 group"
            >
              ...
              <div className="relative z-20 w-full flex-1 min-h-0 flex flex-col justify-between">
                {[
                  ...
                  <div key={tech.name} className="flex flex-col">
                    ...
                    {i < arr.length - 1 && (
                      <div className="h-px w-full bg-neutral-800/80 mt-[2px]" />
                    )}
                  </div>
                ))}
              </div>
          ...
          {/* ── VESSEL 05: Comm Link ─────────────────────────── */}
          {/* Mobile: spans 2 cols | Desktop: 2 cols */}
          <motion.div
            variants={item}
            className="col-span-2 md:col-span-2 relative overflow-hidden bg-surface border border-border rounded-2xl md:rounded-3xl px-4 py-3 md:p-8 flex flex-col justify-between transition-all duration-300 hover:border-neutral-600 active:scale-[0.98] active:border-neutral-500 group"
          >
            ...
            <div className="relative z-20 flex-none flex flex-row items-end justify-between w-full gap-3 mt-2 md:mt-0">
              <div className="pointer-events-none">
                ...
                <h2 className="text-xl sm:text-2xl md:text-5xl font-bold tracking-tight group-hover:text-accent transition-colors duration-300 flex items-center gap-1">
                  ...
                  <svg
                    ...
                    className="md:w-7 md:h-7 transform group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform duration-300"
                  >
              ...
              <div className="flex gap-2 relative z-30 flex-shrink-0">
                <a
                  ...
                  className="px-3 py-1.5 md:px-4 md:py-2 text-[10px] md:text-sm bg-neutral-800/50 rounded-full border border-neutral-700/50 text-neutral-400 hover:text-white hover:border-neutral-500 active:scale-95 transition-all backdrop-blur-sm"
                >
                  GitHub
                </a>
                <a
